...
public class DAOResto extends DAOModele {
    ...
    public static resto getRestoByNom(String nomR) {
        //Récupère dans un Cursor les valeurs correspondant à un article grâce à sa designation)
        Cursor c = db.query(TABLE_resto, new String[]{COL_ID_RESTO, COL_NOM_RESTO, COL_VILLE_RESTO}, COL_NOM_RESTO + " LIKE \"" + nomR + "\"", null, null, null, null);
